...
<?php
  ...
  foreach( $forums AS $section )
  {
  
?>
  <table style="width:100%;margin-top:20px;">
    <tr>
      <th><a href="<?php echo Page::url($section['arborescence']) ?>"><?php echo $section['page_nom'] ?></a></th>
      <th style="width:45px;">Sujets</th>
      <th style="width:65px;">Réponses</th>
      <th style="width:125px;">-</th>
    </tr>
    <?php Template::integrer('pok_forum_index/inter', array( 'forums' => $section['forums'] )) ?>
  </table>
<?php
  }
?>
